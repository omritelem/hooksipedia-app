...
const RepoItem = ({ id, name, owner, html_url, updated_at, created_at, homepage, description, stargazers_count, forks_count, topics }) => {
    // const formattedTopics = useMemo(() => topics ? topics.reduce((acc, topic) => `#${topic} ${acc}`, '') : '', [topics]);
            ...
            <a href={ html_url }
               ...
               rel="noopener noreferrer">
                ...
                <div className="content">
                    ...
                    <div className="owner">
                        <span className="name">By { owner && owner.login }</span> <img src={ owner && owner.avatar_url }
                                                                                       alt="owner img"/>
                    </div>
                </div>
            </a>
